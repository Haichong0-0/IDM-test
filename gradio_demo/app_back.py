...
def start_tryon(dict,garm_img,garm_part,garment_des,is_checked,segment_mask,is_checked_crop,denoise_steps,seed):
    ...
    #temp = dict['layers'][0].convert("RGB").resize((768, 1024))
...
with image_blocks as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            with gr.Row():
                ...
                with gr.Row():
                    parts = ["upper_body",'lower_body','dresses']
                    garm_part = gr.Dropdown(parts,label = "Garment Type")
        ...
        with gr.Column():
            segment_mask = gr.Image(label="Gray Mask", sources='upload', type="pil")
    ...
    try_button.click(fn=start_tryon, inputs=[imgs,garm_img,garm_part, prompt, is_checked,segment_mask,is_checked_crop, denoise_steps, seed], outputs=[image_out,masked_img], api_name='tryon')
